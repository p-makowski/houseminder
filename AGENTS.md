...
House Minder is a PHP 8.3 / Laravel 13 household appliance maintenance tracker with Livewire 3 reactive UI and Tailwind CSS. It stores per-household appliance records, generates AI-based maintenance schedules, and surfaces upcoming/overdue tasks on a dashboard.
